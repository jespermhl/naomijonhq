...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClass =
    "inline-flex items-center justify-center rounded-full border-2 border-border-glass bg-brand-btn text-on-brand font-black no-underline cursor-pointer transition-all duration-200 ease-spring shadow-button hover:-translate-y-1 hover:scale-[1.02] hover:shadow-button-hover active:translate-y-1 active:scale-[0.98] active:shadow-button-active disabled:opacity-45 disabled:pointer-events-none disabled:shadow-none disabled:scale-100 disabled:translate-y-0 max-sm:px-4 max-sm:py-2.5 max-sm:text-[13px] max-sm:min-w-[90px] max-sm:!transform-none";
