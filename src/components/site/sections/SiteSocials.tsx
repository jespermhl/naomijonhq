...
export async function SiteSocials({ section }: { section: SiteSection }) {
  if (section._type !== "socials") return null;
  ...
  return (
    <section className="relative w-full px-6 py-20 max-sm:px-4 max-sm:py-12">
      <div className="mx-auto max-w-275 text-center">
        <SectionHeading
          eyebrow={section.eyebrow || "Stay Connected"}
          title={section.title || "Follow the Socials"}
        />
