...
export function Footer({
  ...
  return (
    <footer className="w-full bg-[var(--bg-base-3)]">
      <div className="mx-auto flex w-full max-w-275 flex-col items-center gap-6 py-8">
        <div className="md:border-border-subtle flex w-full flex-col items-center gap-4 md:flex-row md:justify-between md:border-t md:pt-6">
        {showSocials && (
          <SocialIconBar
            socials={socials}
        ...
        <div className="border-border-subtle order-2 w-full border-t md:hidden" />
