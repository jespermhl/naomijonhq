...
export default function PrivacyPolicy() {
    ...
    return (
        <main className={`${styles.privacyMain} bg-pattern`}>
            <Card maxWidth="800px" className={styles.privacyCard} rotated={false}>
                <h1 className={styles.title}>Privacy Policy</h1>

                <Section title="">
                    <p className={styles.text}>Last Updated: June 2, 2026</p><br />

                    <p className={styles.text}>Thank you for your interest in our website. Protecting your privacy is very important to us. Below, we provide detailed information on how we handle your data.</p>
                </Section>

                <Section title="1. Data Controller">
                    <p className={styles.text}>The data controller in terms of the General Data Protection Regulation (GDPR) is:</p><br />

                    <p className={styles.text}>LF Digital<br />
                ...
                <Section title="2. General Information and Mandatory Information">
                    <p className={styles.text}><b>Data Protection</b><br />
                    ...
                    <p className={styles.text}><b>SSL/TLS Encryption</b><br />
                ...
                <Section title="3. Data Collection on Our Website">
                    <p className={styles.text}><b>a) Hosting via Vercel</b><br />
                        ...
                        For more information, please refer to Vercel's Privacy Policy at: <Link href="https://vercel.com/legal/privacy-policy" className={styles.link}>https://vercel.com/legal/privacy-policy</Link><br /></p>
                </Section>

                <Section title="4. Analytics Tools">
                    <p className={styles.text}><b>a) Vemetric Analytics</b><br />
                ...
                <Section title="5. Newsletter">
                    <p className={styles.text}><b>a) Klaviyo</b><br />
                        ...
                        For more information on data protection at Klaviyo, please visit: <Link href="https://www.klaviyo.com/privacy" className={styles.link}>https://www.klaviyo.com/privacy</Link>
                    </p>
                </Section>

                <Section title="6. Your Rights as a Data Subject">
                    <p className={styles.text}>Under applicable legal regulations, you have the right at any time to:
                ...
                <Section title="7. Right to Object (Art. 21 GDPR)">
                    <p className={styles.text}>If your personal data is processed based on legitimate interests pursuant to Art. 6 (1) sentence 1 lit. f GDPR, you have the right, pursuant to Art. 21 GDPR, to object to the processing of your personal data, provided that there are reasons arising from your particular situation.<br /><br />

                        If you wish to make use of your right to object, an email is sufficient: <Link href={`mailto:${mailAdress}`} className={styles.link}>{mailAdress}</Link></p>
                </Section>
            </Card>
        </main >
    );
