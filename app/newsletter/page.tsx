...
async function getSocials() {
    try {
        return await client.fetch(`*[_type == "social"] | order(order asc) {
            name,
            url,
            platform
        }`);
    } catch (e) {
        console.error("Failed to fetch socials from Sanity:", e);
        return [];
    }
}
