...
function StrawberryCountdownContent() {
  ...
  useEffect(() => {
    // If the released parameter is present, force the finished state for previewing
    if (releasedParam) {
      setIsFinished(true);
      return;
    }
        ...
        <div
          ...
          style={{
            ...
            animation: isFinished
              ...
              : "wobble 4s ease-in-out infinite",
          }}
        >
          <div
            style={{
          ...
          <a
            ...
            onMouseOver={(e) => {
              e.currentTarget.style.transform =
                "translateY(-4px) rotate(0deg) scale(1.05)";
